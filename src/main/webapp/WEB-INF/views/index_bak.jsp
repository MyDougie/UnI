						...
						<div class="row">
							...
							<div class="col-sm-5">
								<ul class="fh5co-social-icons">
									<li><i class="icon-twitter-with-circle"></i></a></li>
									<li><i class="icon-facebook-with-circle"></i></a></li>
									<li><i class="icon-linkedin-with-circle"></i></a></li>
									<li><i class="icon-dribbble-with-circle"></i></a></li>
								</ul>
							</div>
						</div>
					</div>
	...
	<aside id="fh5co-hero">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4">
					<a href="#" class="featured text-center animate-box" style="background-image: url(${pageContext.request.contextPath}/resources/images/img_bg_3.jpg);">
						<div class="desc">
					...
					<a href="#" class="featured text-center animate-box" style="background-image: url(${pageContext.request.contextPath}/resources/images/img_bg_2.jpg);">
						<div class="desc">
							<span class="date">Dec 25, 2016</span>
